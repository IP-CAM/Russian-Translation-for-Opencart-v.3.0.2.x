...
$_['button_shipping']       = 'Применить способ';
$_['button_submit']         = 'Отправить';
$_['button_guest']          = 'Гостевое оформление';
$_['button_view']           = 'Посмотреть';
$_['button_voucher']        = 'Использовать сертификат';
$_['button_upload']         = 'Загрузить файл';
$_['button_reward']         = 'Использовать бонусы';
$_['button_quote']          = 'Вычислить стоимость';
$_['button_list']           = 'Список';
$_['button_grid']           = 'Сетка';
$_['button_map']            = 'Посмотреть карту Google';

// Error
$_['error_exception']       = 'Ошибка с кодом(%s): %s в %s строка %s';
